...
Ext.define(
				"Volt.view.Main",
				{
					...
					requires : [ 'Ext.Container', 'Ext.MessageBox',
							'Ext.Panel', 'Ext.Toolbar',
					...
					config : {
						...
						/**
						 * Any component within the container with an
						 * 'x-toolbar' class will be draggable. To disable
						 * draggin all together, set this to false.
						 */
						slideSelector : 'x-toolbar',

						/**
						 * Container must be dragged 10 pixels horizontally
						 * before allowing the underlying container to actually
						 * be dragged.
						 * 
						 * @since 0.2.2
						 */
						...
						/**
						 * Time in milliseconds to animate the closing of the
						 * container after an item has been clicked on in the
						 * list.
						 */
						...
						/**
						 * Define the default slide button config. Any item that
						 * has a `slideButton` value that is either `true` or a
						 * button config will use these values at the default.
						 */
						slideButtonDefaults : {
							selector : 'toolbar'
						},
						...
						/**
						 * This allows us to configure how the actual list
						 * container looks. Here we've added a custom search
						 * field and have modified the width.
						 */
						list : {
							maxDrag : 400,
							width : 200,
							...
							/**
							 * Here's an example of how to add a different type
							 * of component into the toolbar of the list.
							 */
							/*
							 * items: [{ docked: 'top', xtype: 'searchfield',
							 * placeHolder: 'search', width: 180 }]
							 */
							} ]
						...
						/**
						 * Change this to 'right' to dock the navigation list to
						 * the right.
						 */
						listPosition : 'left',
						...
						/**
						 * These are the default values to apply to the items
...
//								},
								{
									...
									group : 'Group 1',
									/**
									 * Here's an example of how an item can
									 * simply execute a function, rather than
									 * display a new component.
									 */
									handler : function() {
										Ext.Msg.alert('Item 2',
												'You clicked Item 2.');
									}
								},
								{
								...
								},
								{
									...
									// Explicitly disable `slideButton` (this is
									// the default)
									slideButton : false,
